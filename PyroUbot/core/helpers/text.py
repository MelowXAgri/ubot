...
<b>💳 ᴍᴏᴛᴏᴅᴇ ᴘᴇᴍʙᴀʏᴀʀᴀɴ:</b>
 <b>├ ᴅᴀɴᴀ/ɢᴏᴘᴀʏ/ᴏᴠᴏ</b>
 <b>├────• <code>085281610760</code></b>
 <b>├ ǫʀɪs</b>
 <b>└────• <a href=https://telegra.ph/payment-qris-11-11>ᴋʟɪᴋ ᴅɪsɪɴɪ</a></b>
...
• sᴜᴘᴘᴏʀᴛ @klimaxadmin ᴅɪ ᴛᴇʟᴇɢʀᴀᴍ
...
"""
    ...
    async def USERBOT(count):
        ...
        expired_time = expired_date.strftime("%d-%m-%Y") if expired_date else None
        return f"""
...
<b> ╰ ᴇxᴘɪʀᴇᴅ</b> <code>{expired_time}</code>
"""
