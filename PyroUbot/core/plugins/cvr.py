...
async def convert_efek(client, message):
    ...
    if reply and args in list_efek:
...
async def colong_cmn(client, message):
    ...
    if (
        ...
        or reply_message.document
    ):
        if reply_message.photo and reply_message.photo.file_size > 10000000:
            return await Tm.edit("ꜰɪʟᴇ ᴅɪ ᴀᴛᴀs 10ᴍʙ ᴛɪᴅᴀᴋ ᴅɪ ɪᴢɪɴᴋᴀɴ")
        elif reply_message.video and reply_message.video.file_size > 10000000:
            return await Tm.edit("ꜰɪʟᴇ ᴅɪ ᴀᴛᴀs 10ᴍʙ ᴛɪᴅᴀᴋ ᴅɪ ɪᴢɪɴᴋᴀɴ")
        elif reply_message.audio and reply_message.audio.file_size > 10000000:
            return await Tm.edit("ꜰɪʟᴇ ᴅɪ ᴀᴛᴀs 10ᴍʙ ᴛɪᴅᴀᴋ ᴅɪ ɪᴢɪɴᴋᴀɴ")
        elif reply_message.voice and reply_message.voice.file_size > 10000000:
            return await Tm.edit("ꜰɪʟᴇ ᴅɪ ᴀᴛᴀs 10ᴍʙ ᴛɪᴅᴀᴋ ᴅɪ ɪᴢɪɴᴋᴀɴ")
        elif reply_message.document and reply_message.document.file_size > 10000000:
            return await Tm.edit("ꜰɪʟᴇ ᴅɪ ᴀᴛᴀs 10ᴍʙ ᴛɪᴅᴀᴋ ᴅɪ ɪᴢɪɴᴋᴀɴ")

        media = await client.download_media(reply_message)

        if reply_message.photo:
            await client.send_photo(client.me.id, media, reply_message.caption)
        elif reply_message.video:
            await client.send_video(client.me.id, media, reply_message.caption)
        elif reply_message.audio:
            await client.send_audio(client.me.id, media, reply_message.caption)
        elif reply_message.voice:
            await client.send_voice(client.me.id, media, reply_message.caption)
        elif reply_message.document:
            await client.send_document(client.me.id, media, reply_message.caption)

        os.remove(media)
        await message.delete()
        return await Tm.delete()
    else:
        return await Tm.edit("sᴇᴘᴇʀᴛɪɴʏᴀ ᴛᴇʀᴊᴀᴅɪ ᴋᴇsᴀʟᴀʜᴀɴ")
